        ...
        function _0x11a7a2(_0x193f00, _0x1cfe89) {
            ...
            try {
                ...
                if (op > 0x14) {
                    ...
                    eval('window.b64pad = window[\'$_zw\'][9][\'length\'];');
                } else if (op < 0xa) {
...
(() => {
    /* 自定义获取数据，全局变量为myGetData={} */
    myGetData.cookie = document.cookie;
    myGetData.params_m = window._$is;
    myGetData.params_f = window.$_zw[23];
})();