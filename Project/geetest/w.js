...
!function() {
  !function(t, e) {
      ...
      window.my_aa1 = W[$_CJEq(269)]["\u0024\u005f\u0046\u0044\u004c"];
      window.my_aa = W[$_CJEq(269)]["\u0024\u005f\u0042\u0042\u0045\u0049"];
      Z[$_CJEq(269)] = {
          "\u0024\u005f\u0048\u0041\u0052": function(t) {
...
// 取得u值
function get_u() {
    return new window.kribe()["encrypt"](cal());
}


// 取得l值
function get_l() {
	return window.my_v(JSON.stringify(o), cal())
}